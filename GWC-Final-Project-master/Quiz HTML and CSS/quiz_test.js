...
["Midwest","Rural","Public","15,000+","30,000-50,000"," University of Illinois at Urbana-Champaign "],
...
["Midwest","Urban","Private","2,000-8,000","30,000-50,000"," Illinois Institute of Technology "],
["Midwest","Suburban","Public","15,000+","30,000-50,000"," Michigan State "],
...
["Northeast","Urban","Public","8,000-15,000","50,000+"," Northeastern University "],
["Northeast","Urban","Private","2,000-8,000","50,000+"," Georgetown University "],
["Northeast","Suburban","Private","8,000-15,000","50,000+"," Boston University "],
["Northeast","Urban","Private","15,000+","30,000-50,000"," New York University "],
...
["Southeast","Suburban","Public","15,000+","10,000-30,000"," University of Alabama "],
["Southeast","Urban","Private","2,000-8,000","50,000+"," Emory University "],
["Southeast","Rural","Public","15,000+","10,000-30,000"," Virginia Polytechnic University "],
...
["Southwest","Urban","Public","15,000+","30,000-50,000"," University of Arizona "],
...
function checkQ(idToCheck, attributeName){
    ...
    document.getElementById(attributeName).style.backgroundColor = "#00FA9A";
...
function submitQ5(){
  ...
  var listOfSelectedCollegesA = [];
  var listOfSelectedCollegesWithR = [];
  var listOfSelectedCollegesWithRS = [];
  var listOfSelectedCollegesWithRST = [];
  var listOfSelectedCollegesWithRSTP = [];
  var listOfSelectedCollegesWithRSTPT = [];
  ...
  for (i = 0; i < listOfColleges.length; i++){
    ...
    for (r = 0; r < listOfColleges.length; r++){
      if(listOfColleges[r] !== undefined && region === listOfColleges[r][0] && setting === listOfColleges[r][1] && type1 === listOfColleges[r][2]){
        listOfSelectedCollegesWithRST.push(listOfColleges[r][5]);
      }
    }
    for (n = 0; n < listOfColleges.length; n++){
      if(listOfColleges[n] !== undefined && region === listOfColleges[n][0] && setting === listOfColleges[n][1] && type1 === listOfColleges[n][2] && pop === listOfColleges[n][3]){
        listOfSelectedCollegesWithRSTP.push(listOfColleges[n][5]);
      }
    }
    for (m = 0; m < listOfColleges.length; m++){
      if(listOfColleges[m] !== undefined && region === listOfColleges[m][0] && setting === listOfColleges[m][1] && type1 === listOfColleges[m][2] && pop === listOfColleges[m][3] && tuition === listOfColleges[m][4]){
        listOfSelectedCollegesWithRSTPT.push(listOfColleges[m][5]);
      }
    }
    document.getElementById("placeHolderForResults1").innerHTML = listOfSelectedCollegesWithR;
    document.getElementById("placeHolderForResults2").innerHTML = listOfSelectedCollegesWithRS;
    document.getElementById("placeHolderForResults3").innerHTML = listOfSelectedCollegesWithRST;
    document.getElementById("placeHolderForResults4").innerHTML = listOfSelectedCollegesWithRSTP;
    document.getElementById("placeHolderForResults5").innerHTML = listOfSelectedCollegesWithRSTPT;

  for(x=0; x<listOfColleges.length;x++){
    count=0;
    if(listOfColleges[x] !== undefined && region === listOfColleges[x][0]){
        //listOfSelectedColleges.push(listOfColleges[i][5]);
      count+=2;
    }
    if(listOfColleges[x] !== undefined && setting === listOfColleges[x][1]){
      //listOfSelectedColleges.push(listOfColleges[x][5]);
      count+=3;
    }
    if(listOfColleges[x] !== undefined && type1 === listOfColleges[x][2]){
      //listOfSelectedColleges.push(listOfColleges[r][5]);
      count+=1;
    }
    if(listOfColleges[x] !== undefined && pop === listOfColleges[x][3]){
      //listOfSelectedColleges.push(listOfColleges[n][5]);
      count+=2;
    }
    if(listOfColleges[x] !== undefined && tuition === listOfColleges[x][4]){
      //listOfSelectedColleges.push(listOfColleges[m][5]);
      count+=4;
    }
    if(count>7){
      listOfSelectedCollegesA.push(listOfColleges[x][5]);
    }
  }
  document.getElementById("placeHolderForResults6").innerHTML = listOfSelectedCollegesA;
